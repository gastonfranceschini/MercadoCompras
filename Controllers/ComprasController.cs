...
namespace MercadoCompras.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public ComprasController(MercadoComprasDbContext context)
        {
            _context = context;
        }
        ...
        {
            var mercadoComprasDbContext = _context.Compras.Include(c => c.Carrito).Include(c => c.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("Id,CarritoId,ClienteId,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,CarritoId,ClienteId,Total")] Compra compra)
        {
            if (id != compra.Id)
            {
                return NotFound();
